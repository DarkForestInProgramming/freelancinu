<x-profile :sharedData="$sharedData" docTitle="{{$sharedData['username']}} Sekėjai">
    <div class="w-full">
        ...
        <div class="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
            ...
            <a href="/profile/{{$follow->userDoingTheFollowing->username}}" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150">
