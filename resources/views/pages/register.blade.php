...
<div class="flex items-center justify-center">
    <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="/register" method="POST" class="space-y-4">
            @csrf
            <div>
                <label for="username" class="block mb-1 text-sm text-gray-500 font-medium">Vartotojo vardas</label>
            ...
            <div>
                <label for="confirm-password" class="block mb-1 text-sm text-gray-500 font-medium">Pakartoti slaptažodį</label>
