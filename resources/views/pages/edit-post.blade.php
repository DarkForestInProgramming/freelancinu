...
<div class="container mx-auto py-8">
    <form action="/post/{{$post->id}}" method="POST" class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        @method("PUT")
        ...
        <div>
            <button type="submit" class="w-full bg-laravel text-white px-4 py-2 rounded-md hover:bg-red-600">Išsaugoti pakeitimus</button>
        </div>
        <x-divider />
