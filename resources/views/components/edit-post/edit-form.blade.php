<form class="max-w-md mx-auto bg-white md:shadow-md rounded px-8 pt-6 pb-8 mb-4" action="/topic/{{$post->id}}" method="POST">
    @csrf
    @method("PUT")
    ...
    <div class="mb-4">
        ...
        <input value="{{@old('title', $post->title)}}" type="text" id="title" name="title" class="w-full title border border-gray-300 p-2 outline-none rounded">
        @error('title')
