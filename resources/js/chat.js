...
export default class Chat {
    ...
    <div class="chat-title-bar">Gyvas Pokalbis <span class="chat-title-bar-close"><i class="fas fa-times-circle"></i></span></div>
    <div id="chat" class="chat-log"></div>
    
    <form id="chatForm" class="chat-form border-t">
      <input type="text" class="chat-field" id="chatField" placeholder="Įveskite tekstą…" autocomplete="off">
    </form>
    `;
    }
}
